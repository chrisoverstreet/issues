defmodule Issues.TableFormatter do
  ...
  @doc """
  Return a binary (string) version of orur parameter.
  ## Examples
  ...
  a column, return a list containing the maximum widht of each column.
  ## Example
  ...
  @doc """
  Given a list containing rows of data, a list containing hte header selectors,
